...
public class MajoritarianCentralisedRunnableOrchestrationTest {
...
//requester: 0
        ...
        msg = (String) oin.readObject(); // reading payload centralised action
        assertEquals(msg,null);
        oout.writeObject("request_payload");
        oout.flush();

        //requester: 0
//choice to: 0
        msg = (String) oin.readObject(); //receiving the matching offer
        assertEquals(msg, "offer_payload");
        msg = (String) oin.readObject();
...
//choice to: 0
        ...
        assertEquals(msg,RunnableOrchestration.choice_msg);
//choice options to: 0
        String[] choices = (String[]) oin.readObject();
        String choice = RunnableOrchestration.stop_choice;
...
//matching offerer: 1
        ...
        assertEquals(msg, "coffee");
        msg = (String) oin.readObject(); // reading payload centralised action
        assertEquals(msg,"request_payload");
        oout.writeObject("offer_payload");
        oout.flush();
